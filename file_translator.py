...
def main():
    target = translate("Hello, good morning!", BASE_URL, MY_KEY, "en-ar", "general")
    print(target)


    target = translate("سيُعرض في #كتارا ثلاث أفلام باكستانية بالتعاون مع سفارة جمهورية #باكستان الإسلامية لدى #قطر الدعوة عامة", BASE_URL, MY_KEY, "ar-en", "general")
    print(target)
